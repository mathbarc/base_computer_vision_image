...
RUN apt update;DEBIAN_FRONTEND=noninteractive apt install cmake build-essential git libavcodec-dev libavformat-dev libavresample-dev libswscale-dev libeigen3-dev libtesseract-dev libopenni2-dev libopenni-dev libusb-1.0-0-dev libgdal-dev libgdcm-dev -y; apt clean --dry-run; apt autoclean; mkdir /home/libs
