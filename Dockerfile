...
RUN apt update;DEBIAN_FRONTEND=noninteractive apt install cmake build-essential git -y; apt clean --dry-run; apt autoclean; pip3 install numpy; mkdir /home/libs
